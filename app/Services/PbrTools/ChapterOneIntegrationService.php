...
class ChapterOneIntegrationService
{
    ...
    public function prefill(
        ...
        if (
            ...
            if (
                $this->blank(
                    $input['base_capital'] ?? null
                )
            ) {
                $input['base_capital'] =
                    round(
                        $summary['startup_capital']
        ...
        if (
            ...
            if (
                $this->blank(
                    $input['partner_capital'] ?? null
                )
            ) {
                $input['partner_capital'] =
                    $summary['partner_capital'];
            }

            if (
                $this->blank(
                    $input['other_funding'] ?? null
                )
                && $summary['other_funding'] > 0
            ) {
                $input['other_funding'] =
                    $summary['other_funding'];
            }
        }
